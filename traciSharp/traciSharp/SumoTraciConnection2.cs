...
{
    public class SumoTraciConnection2
    {
        ...
        public void addOption(String paramString1, String paramString2)
        {

            if (paramString2 != null)
            {
                this.args.Add("--" + paramString1);
                this.args.Add(paramString2);
            }
        }
...

        {
            ...
            try
            {
                this.cp.do_job_set(paramSumoCommand);
            }
...

        {
            ...
            try
            {
                localObject = this.cp.do_job_get(paramSumoCommand);
            }
            catch (Exception localException)
            {
                closeAndDontCareAboutInterruptedException();
        ...
        //private  class StreamLogger : Runnable
        //{
        //    static readonly Stream stream;
        //    static readonly String prefix;


        //    public StreamLogger(Stream paramInputStream, String paramString)
        //    {
        ...
        //    public void run()
        //    {
        //        BinaryReader localBufferedReader = new BinaryReader(this.stream));
        //        try
        //        {
        //            String str;
        //            while ((str = localBufferedReader.readLine()) != null)
        //            {
        //                if ((str.Contains("Error:")) && (!str.Contains("peer shutdown")))
        //                {
