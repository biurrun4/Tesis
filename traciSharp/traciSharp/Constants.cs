...
namespace sumo.config
{
    public class Constants
    {
        ...
        // VERSION
        // ****************************************
        public const int TRACI_VERSION = 5;
        ...
        public const int CMD_SIMSTEP2 = 0x02;
        ...
        /** command: add vehicle */
        public const int CMD_ADDVEHICLE = 0x74;
        ...
        public const int CMD_SUBSCRIBE_LANE_AREA_DETECTOR_CONTEXT = 0x8d;
        /** response: subscribe lane area detector (e2) context */
        public const int RESPONSE_SUBSCRIBE_LANE_AREA_DETECTOR_CONTEXT = 0x9d;
        /** command: get lane area detector (e2) variable */
        public const int CMD_GET_LANE_AREA_DETECTOR_VARIABLE = 0xad;
        /** response: get lane area detector (e2) variable */
        public const int RESPONSE_GET_LANE_AREA_DETECTOR_VARIABLE = 0xbd;
        /** command: subscribe lane area detector (e2) variable */
        public const int CMD_SUBSCRIBE_LANE_AREA_DETECTOR_VARIABLE = 0xdd;
        /** response: subscribe lane area detector (e2) variable */
        public const int RESPONSE_SUBSCRIBE_LANE_AREA_DETECTOR_VARIABLE = 0xed;

        /** command: subscribe multi-entry/multi-exit detector (e3) context */
        public const int CMD_SUBSCRIBE_MULTI_ENTRY_EXIT_DETECTOR_CONTEXT = 0x81;
        /** response: subscribe multi-entry/multi-exit detector (e3) context */
        public const int RESPONSE_SUBSCRIBE_MULTI_ENTRY_EXIT_DETECTOR_CONTEXT = 0x91;
        /** command: get multi-entry/multi-exit detector (e3) variable */
        public const int CMD_GET_MULTI_ENTRY_EXIT_DETECTOR_VARIABLE = 0xa1;
        /** response: get multi-entry/multi-exit detector (e3) variable */
        public const int RESPONSE_GET_MULTI_ENTRY_EXIT_DETECTOR_VARIABLE = 0xb1;
        /** command: subscribe multi-entry/multi-exit detector (e3) variable */
        public const int CMD_SUBSCRIBE_MULTI_ENTRY_EXIT_DETECTOR_VARIABLE = 0xd1;
        /** response: subscribe multi-entry/multi-exit detector (e3) variable */
        public const int RESPONSE_SUBSCRIBE_MULTI_ENTRY_EXIT_DETECTOR_VARIABLE = 0xe1;
        ...
        public const int POSITION_LAT_LON = 0x00;
        /** 2D cartesian coordinates */
        public const int POSITION_2D = 0x01;
        /** Position in geo-coordinates with altitude */
        public const int POSITION_LAT_LON_ALT = 0x02;
        ...
        public const int TYPE_BOUNDINGBOX = 0x05;
        /** Polygon (2*n doubles) */
        ...
        // ****************************************
        /** red phase */
        public const int TLPHASE_RED = 0x01;
        /** yellow phase */
        public const int TLPHASE_YELLOW = 0x02;
        /** green phase */
        public const int TLPHASE_GREEN = 0x03;
        /** tl is blinking */
        public const int TLPHASE_BLINKING = 0x04;
        /** tl is off and not blinking */
        public const int TLPHASE_NOSIGNAL = 0x05;
        ...
        public const int ID_LIST = 0x00;

        /** count of instances (get: all) */
        public const int ID_COUNT = 0x01;

        /** subscribe object variables (get: all) */
        public const int OBJECT_VARIABLES_SUBSCRIPTION = 0x02;

        /** subscribe context variables (get: all) */
        public const int SURROUNDING_VARIABLES_SUBSCRIPTION = 0x03;
        ...
        public const int VAR_MOVE_TO_VTD = 0xb4;
        ...
        public const int VAR_WAITING_TIME = 122;

        /** lane change mode (change: vehicle state) */
        public const int VAR_LANE_CHANGE_MODE = 0xb6;
    }
}