...
namespace sumo.util
{
    public class SumoCommand
    {
        ...
        public SumoCommand(Object paramObject1, Object paramObject2, Object paramObject3, Object paramObject4, Object paramObject5)
        {
            this.cmd = new Command((Convert.ToInt32(paramObject1)));
            ...
            this.input1 = (Convert.ToInt32(paramObject1));
        ...
        public SumoCommand(Object paramObject1, Object paramObject2, Object paramObject3, Object paramObject4, Object paramObject5, String paramString)
        {
            this.cmd = new Command((Convert.ToInt32(paramObject1)));
            this.cmd.Content().writeUnsignedByte((Convert.ToInt32(paramObject2)));
            this.cmd.Content().writeStringASCII(Convert.ToString(paramObject3));
        ...
        public SumoCommand(Object paramObject1, Object paramObject2, Object paramObject3, Object[] paramArrayOfObject, Object paramObject4, Object paramObject5)
        {
            this.cmd = new Command((Convert.ToInt32(paramObject1)));
            this.cmd.Content().writeUnsignedByte((Convert.ToInt32(paramObject2)));
            this.cmd.Content().writeStringASCII(Convert.ToString(paramObject3));
            ...
            {
                add_type(paramArrayOfObject[0]);
                add_variable(paramArrayOfObject[0]);
            }
            else
            {
                this.cmd.Content().writeUnsignedByte(15);
                if (((Convert.ToInt32(paramObject1)) == 164) && (((Convert.ToInt32(paramObject2)) == 131)))
                {
                    this.cmd.Content().writeInt(2);
                    if (paramArrayOfObject.Length == 3)
                    {
                        this.cmd.Content().writeUnsignedByte(4);
                        this.cmd.Content().writeStringASCII((String)paramArrayOfObject[0]);
                        this.cmd.Content().writeDouble(Convert.ToDouble(paramArrayOfObject[1]));
                        this.cmd.Content().writeUnsignedByte((short)Convert.ToByte(paramArrayOfObject[2]));
                    }
                    else if (paramArrayOfObject.Length == 2)
                    {
                        this.cmd.Content().writeUnsignedByte(1);
                        this.cmd.Content().writeDouble(Convert.ToDouble(paramArrayOfObject[0]));
                        this.cmd.Content().writeDouble(Convert.ToDouble(paramArrayOfObject[1]));
                    }
                    this.cmd.Content().writeUnsignedByte(1);
                }
                ...
                {
                    this.cmd.Content().writeInt(paramArrayOfObject.Length);
                    for (int i = 0; i < paramArrayOfObject.Length; i++)
                    {
                        add_type(paramArrayOfObject[i]);
                        add_variable(paramArrayOfObject[i]);
                    }
                }
            }
            this.input1 = (Convert.ToInt32(paramObject1));
            this.input2 = (Convert.ToInt32(paramObject1));
            this.input3 = Convert.ToString(paramObject3);
            this.response = (Convert.ToInt32(paramObject1));
            this.output_type = (Convert.ToInt32(paramObject1));
            this.raw = new List<Object>();
            this.raw.Add(paramObject1);
            this.raw.Add(paramObject2);
            this.raw.Add(paramObject3);
        ...
        public SumoCommand(Object paramObject1, Object paramObject2)
        {
            this.input1 = Convert.ToInt32(paramObject1);
            this.input2 = Convert.ToInt32(paramObject2);
            this.cmd = new Command((Convert.ToInt32(paramObject1)));
        ...
        public SumoCommand(Object paramObject1, Object paramObject2, Object paramObject3, Object[] paramArrayOfObject)
        {
            this.cmd = new Command((Convert.ToInt32(paramObject1)));
            this.input1 = Convert.ToInt32(paramObject1);
            this.input2 = Convert.ToInt32(paramObject2);
            ...
            else if (Convert.ToInt32(paramObject2) == 87)
            {
                ...
                SumoStringList localSumoStringList = (SumoStringList)paramArrayOfObject[0];
            ...
            else
            {
                ...
                if (Convert.ToInt32(paramObject2) == 163)
                {
                    ...
                    {
                        add_variable(paramArrayOfObject[j]);
                    }
                }
                ...
                else if ((Convert.ToInt32(paramObject1) == 200) && (Convert.ToInt32(paramObject2) == 128))
                {
                    this.cmd.Content().writeUnsignedByte(15);
                    this.cmd.Content().writeInt(5);
                    add_type(paramArrayOfObject[3]);
                    add_variable(paramArrayOfObject[3]);
                    add_type(paramArrayOfObject[1]);
                    add_variable(paramArrayOfObject[1]);
                    add_type(paramArrayOfObject[2]);
                    add_variable(paramArrayOfObject[2]);
                    add_type(paramArrayOfObject[4]);
                    add_variable(paramArrayOfObject[4]);
                    add_type(paramArrayOfObject[0]);
                    add_variable(paramArrayOfObject[0]);
                }
                else if ((Convert.ToInt32(paramObject1) == 199) && (Convert.ToInt32(paramObject2) == 66))
                {
                    this.cmd.Content().writeUnsignedByte(1);
                    add_variable(paramArrayOfObject[0]);
                    add_variable(paramArrayOfObject[1]);
                }
                else if ((Convert.ToInt32(paramObject1) == 199) && (Convert.ToInt32(paramObject2) == 128))
                {
                    this.cmd.Content().writeUnsignedByte(15);
            ...
            this.raw.Add(paramObject2);
            this.raw.Add(paramObject3);
            this.raw.Add(paramArrayOfObject);
        }

        public SumoCommand(Object paramObject1, Object paramObject2, Object paramObject3, Object paramObject4)
        {
            this.cmd = new Command((Convert.ToInt32(paramObject1)));
            this.input1 = Convert.ToInt32(paramObject1);
            this.input2 = Convert.ToInt32(paramObject2);
        ...
        public SumoCommand(Object paramObject1, Object paramObject2, Object[] paramArrayOfObject, Object paramObject3, Object paramObject4)
        {
            this.cmd = new Command((Convert.ToInt32(paramObject1)));
            this.input1 = Convert.ToInt32(paramObject1);
            this.input2 = Convert.ToInt32(paramObject2);
            ...
            if ((Convert.ToInt32(paramObject1) == 171) && (Convert.ToInt32(paramObject2) == 131) && (paramArrayOfObject.Length == 4))
            {
                this.cmd.Content().writeUnsignedByte(15);
                this.cmd.Content().writeInt(3);
                bool bool1 = Convert.ToBoolean((Boolean)paramArrayOfObject[2]);
                bool bool2 = Convert.ToBoolean((Boolean)paramArrayOfObject[3]);
                if (!bool1)
                {
                    this.cmd.Content().writeUnsignedByte(1);
                }
            ...
            else if ((Convert.ToInt32(paramObject1) == 171) && (Convert.ToInt32(paramObject2) == 131) && (paramArrayOfObject.Length == 5))
            {
                this.cmd.Content().writeUnsignedByte(15);
                this.cmd.Content().writeInt(3);
                ...
                this.cmd.Content().writeUnsignedByte(0);
                add_variable(paramArrayOfObject[3]);
                bool bool3 = Convert.ToBoolean((Boolean)paramArrayOfObject[4]);
                if (bool3)
                {
                    this.cmd.Content().writeUnsignedByte(1);
                }
